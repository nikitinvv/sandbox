...
def main(arg):
    ...
    parser.add_argument("--prime", nargs='?', type=int, default=10, help="prime: 3 (default 3). Ratio to position the first angle past 360")
    ...
    seq = interlaced_angle_sequence(nproj_total, nproj_per_rot, prime, continuous_angle)
